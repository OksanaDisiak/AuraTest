...
public class social_network_inheader {
    ...
    @Test
    public void social_network_inheader_test() throws InterruptedException {
    ...
    public static void endtest(){
        System.out.println("TEST OF SOCIAL NETWORK LINKS ENDED");
