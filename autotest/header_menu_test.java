...
public class header_menu_test {
    ...
    @Test
    public void homepage_rest() throws InterruptedException {  // don`t contain test for TV, ABOUT      SUBSCRIBE, SEARCH, LOG IN/OUT - apart
        ...
        //header menu with pages links - feeds, stories, videos etc like elements in list.
        /*  0 - feeds
            1 - stories
            2 - videos
            3 - tv
     ...
     /*   System.out.println(pages_menu.get(0).getText());
        System.out.println(pages_menu.get(1).getText());
        System.out.println(pages_menu.get(2).getText());
        System.out.println(pages_menu.get(3).getText());
        System.out.println(pages_menu.get(4).getText());
        System.out.println(pages_menu.get(5).getText());
        System.out.println(pages_menu.get(6).getText());*/
        ...
        WebElement twitter;
        twitter = driver.findElement(By.cssSelector("a.social-link"));
        twitter.click();
        Thread.sleep(2000);
        WebElement twitter_check = driver.findElement(By.cssSelector("a.ProfileHeaderCard-nameLink"));
